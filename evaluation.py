...
#     sim_pooling = open("similarity_scores_pooling.json")
#     sim_tokens_avg = open("similarity_scores_tokens.json")
...
#     plt.savefig('similarity_scores_only_pool.png')

#     interaction_scores_token.plot(kind='bar', legend=False, figsize=(12, 10))
#     plt.title('Similarity Scores for Sentences')
#     plt.ylabel('Similarity Score')
#     plt.xticks(range(len(wrapped_labels)), wrapped_labels, rotation=45)
#     plt.savefig('similarity_scores_only_tokens.png')
